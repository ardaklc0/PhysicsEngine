...
int vector_simulator() {
	...
	while (!WindowShouldClose())
	{
		...
		if (mouseOnSubmitButton)
		{
			...
			if (IsMouseButtonPressed(MOUSE_LEFT_BUTTON))
			{
				...
				case 4: {
					int posX = std::stoi(nameX);
					int posY = std::stoi(nameY);
					particle4 = Vector2Particle(Vector2D(posX, posY), 100);
					R = particle1.getPosition() + particle2.getPosition() + particle3.getPosition() + particle4.getPosition() +
						particle5.getPosition() + particle6.getPosition() + particle7.getPosition();
					particleR = Vector2Particle(R, 0);
					vectorNumber++;
				...
				case 5: {
					int posX = std::stoi(nameX);
					int posY = std::stoi(nameY);
					particle5 = Vector2Particle(Vector2D(posX, posY), 100);
					R = particle1.getPosition() + particle2.getPosition() + particle3.getPosition() + particle4.getPosition() +
						particle5.getPosition() + particle6.getPosition() + particle7.getPosition();
					particleR = Vector2Particle(R, 0);
					vectorNumber++;
				...
				case 6: {
					int posX = std::stoi(nameX);
					int posY = std::stoi(nameY);
					particle6 = Vector2Particle(Vector2D(posX, posY), 100);
					R = particle1.getPosition() + particle2.getPosition() + particle3.getPosition() + particle4.getPosition() +
						particle5.getPosition() + particle6.getPosition() + particle7.getPosition();
					particleR = Vector2Particle(R, 0);
					vectorNumber++;
				...
				case 7: {
					int posX = std::stoi(nameX);
					int posY = std::stoi(nameY);
					particle7 = Vector2Particle(Vector2D(posX, posY), 100);
					R = particle1.getPosition() + particle2.getPosition() + particle3.getPosition() + particle4.getPosition() +
						particle5.getPosition() + particle6.getPosition() + particle7.getPosition();
					particleR = Vector2Particle(R, 0);
					vectorNumber++;
		...
		CustomRaylib::PlotThickOriginVector2D(screenWidth, screenHeight, particle4.getXPosition(), particle4.getYPosition(), BLUE, 1);
		CustomRaylib::WriteLegend(10, 70, "Vector 4", BLUE);

		CustomRaylib::PlotThickOriginVector2D(screenWidth, screenHeight, particle5.getXPosition(), particle5.getYPosition(), YELLOW, 1);
		CustomRaylib::WriteLegend(10, 90, "Vector 5", YELLOW);

		CustomRaylib::PlotThickOriginVector2D(screenWidth, screenHeight, particle6.getXPosition(), particle6.getYPosition(), GRAY, 1);
		CustomRaylib::WriteLegend(10, 110, "Vector 6", GRAY);

		CustomRaylib::PlotThickOriginVector2D(screenWidth, screenHeight, particle7.getXPosition(), particle7.getYPosition(), VIOLET, 1);
